...
## 1. Módulo: Autenticación y Registro de Usuario
...
### 1.4 Solicitar Consentimiento del Acudiente
...
#### 1.4.1 Reenviar Solicitud de Consentimiento
...
### 1.7 Aceptar Términos y Condiciones
...
### 1.8 Inicio de Sesión y Definición de Rol
...
## 2. Módulo: Restablecimiento de Contraseña (HU-05)
...
#### 3.4.2 Token de APPRENTICE o INSTRUCTOR
...
### 3.6 Endpoints Protegidos por Rol
...
### 3.7 Anexo — Script SQL (repetido en el documento original)
